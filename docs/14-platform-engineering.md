# 第14章【L2 支撑】平台工程与开发者自助体系
<!-- 第五篇 平台工程与自治 ｜ 常规章（去产品、重思想） ｜ 状态：终审中 -->

> 🧭 **本篇路标 · 第五篇「平台工程与运维自治闭环」（第 14–15 章）**：本篇是全书终点站——第 14 章把治理能力封装成平台黄金路径，第 15 章完成 L2 运维自治闭环，并在 15.4⑤/15.5 落地 L3 Agent 引擎：建议式分诊、评测门禁与七步施工路线。前 14 章搭建的控制系统在此收束成环——AI 原生运维主旨从立论变为可运行工程。

> 本章定位：第五篇开篇，去产品、重思想——平台工程的核心不是搭建运维平台，而是屏蔽基础设施复杂度、统一生产运行标准，为第 15 章自治闭环铺路。
> **主线定位**：能力封装是 L2 运维自治的操控面——让自治可被业务安全使用；运维 Agent 的制品（规则表/白名单/护栏）经平台黄金路径交付，不另起系统。**承上启下**：承第 8–13 章能力；启第 15 章（封装的能力在此成环）。
